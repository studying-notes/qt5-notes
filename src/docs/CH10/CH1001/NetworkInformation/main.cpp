...
//    spdlog::rotating_logger_mt("networkinformation", "networkinformation.log", 1048576 * 50, 30);
//    spdlog::set_level(spdlog::level::debug);// Set global log level to debug
    ...
    QCoreApplication::setApplicationName("networkinformation");
    ...
    parser.setApplicationDescription("networkinformation Description");
