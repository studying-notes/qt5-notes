...
//    spdlog::rotating_logger_mt("udpserver", "udpserver.log", 1048576 * 50, 30);
//    spdlog::set_level(spdlog::level::debug);// Set global log level to debug
    ...
    QCoreApplication::setApplicationName("udpserver");
    ...
    parser.setApplicationDescription("udpserver Description");
